<nav class="fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 shadow-lg z-50">
    <div class="flex items-center justify-around px-4 py-3">
        <a href="{{ route('dashboard') }}"
            ...
            <span class="text-xs font-medium">{{ __('ui.home') }}</span>
        </a>
        <a href="{{ route('service.index') }}"
            ...
            <span class="text-xs font-medium">{{ __('ui.support') }}</span>
        </a>
        <a href="{{ route('menu.index') }}"
            ...
            <span class="text-xs font-medium">{{ __('ui.menu') }}</span>
        </a>
        <a href="{{ route('records.index') }}"
            ...
            <span class="text-xs font-medium">{{ __('ui.record') }}</span>
        </a>
        <a href="{{ route('profile.home') }}"
            ...
            <span class="text-xs font-medium">{{ __('ui.profile') }}</span>
        </a>
    </div>
</nav>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-purple-600 mt-1">
                                                <i class="fas fa-users"></i> {{ $user->referrals->count() }}
                                                {{ __('ui.referrals') }}
                                            </div>
                                        </div>
                                    </div>
                                    <div class="text-right">
                                        <div class="text-xs text-gray-500">{{ __('ui.joined') }}</div>
                                        <div class="text-sm font-medium text-gray-700">{{ $user->created_at->format('M d, Y') }}
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            ...
                                            <div class="text-xs text-green-600 mt-1">
                                                <i class="fas fa-sitemap"></i> {{ __('ui.referred_by') }}
                                                {{ $user->referrer->name }}
                                            </div>
                                        </div>
                                    </div>

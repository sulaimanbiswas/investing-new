...
@section('title', 'Referral Commissions - ' . config('app.name'))
...
@section('content')
    ...
    <div class="bg-gradient-to-br from-indigo-500 to-purple-600 rounded-xl shadow-lg p-6 mb-6 text-white">
        <div class="flex items-center justify-between mb-4">
            <div>
                <p class="text-indigo-100 text-sm mb-1">Total Earnings</p>
        ...
        <div class="grid grid-cols-3 gap-3 mt-4 pt-4 border-t border-white/20">
            <div class="text-center">
                <p class="text-indigo-100 text-xs mb-1">Level 1</p>
                <p class="font-semibold text-sm">{{ number_format($totals['level1'], 2) }}</p>
            </div>
            <div class="text-center">
                <p class="text-indigo-100 text-xs mb-1">Level 2</p>
                <p class="font-semibold text-sm">{{ number_format($totals['level2'], 2) }}</p>
            </div>
            <div class="text-center">
                <p class="text-indigo-100 text-xs mb-1">Level 3</p>
    ...
    <div class="bg-white rounded-xl shadow-sm p-4 mb-4">
        <h3 class="text-lg font-semibold text-gray-800 mb-4">Commission History</h3>
        ...
        <div class="space-y-3">
                        ...
                        <div class="flex-1">
                            <div class="flex items-center gap-2 mb-1">
                                ...
                                @if($commission->level == 1)
                                    <span class="text-xs font-semibold text-blue-600 bg-blue-50 px-2 py-0.5 rounded">Level 1</span>
                                @elseif($commission->level == 2)
                                    <span class="text-xs font-semibold text-purple-600 bg-purple-50 px-2 py-0.5 rounded">Level 2</span>
                                @else
                                    <span class="text-xs font-semibold text-green-600 bg-green-50 px-2 py-0.5 rounded">Level 3</span>
                                @endif
                            </div>
            ...
            @empty
                <div class="text-center py-8">
                    ...
                    <h4 class="text-gray-800 font-semibold mb-1">No Commissions Yet</h4>
                    <p class="text-gray-500 text-sm">You haven't earned any referral commissions yet</p>
                </div>
            @endforelse
        </div>
    </div>
        ...
        <div class="flex gap-3">
            ...
            <div>
                ...
                <ul class="text-sm text-blue-700 space-y-1">
                    <li><strong>Level 1:</strong> Direct referrals - Earn commission when your direct referrals make deposits</li>
                    <li><strong>Level 2:</strong> Indirect referrals - Earn commission from your referrals' referrals</li>
                    <li><strong>Level 3:</strong> Third level - Earn commission from the third generation of referrals</li>
                </ul>
            </div>
        </div>
    </div>
